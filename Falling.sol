...
/**
 * @title Falling
 * @dev The kirsh completely on-chain Video NFT in history.
 *      The media file is published on the Ethereum Virtual
 *      Machine file system and is encoded in Kirsh format.
 *      This work is dedicated to the memory of Monkey
 *      Punch, who has taught me how to be a romantic
 *      modern hero.
 */
contract Falling is ERC721, Ownable {
    constructor() Ownable(InitialOwner) ERC721("Falling", "SQUALL") {}

    address InitialOwner = 0x6E5163fC4BFc1511Dbe06bB605cc14a3e462332b;
    string public hijess = "urmalife";
    string public video = "";
